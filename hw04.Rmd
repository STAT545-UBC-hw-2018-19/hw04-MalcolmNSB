...
Inner join will join only the common rows in both data frames; in this case both Norway and Russia will be absent. The ordering of the columns will be according to the ordering of the data frames specified in the inner_join function.
